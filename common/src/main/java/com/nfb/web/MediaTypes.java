...
public final class MediaTypes {
    ...
    public static final String APPLICATION_OCTET_STREAM_UTF_8 = "application/octet-stream; charset=UTF-8";

    public static final String APPLICATION_FORM_URL_ENCODED_UTF_8 = "application/x-www-form-urlencoded;charset=utf-8";
}
